...
ents_entity_manager_t ents_entity_manager_new()
{
    ents_entity_manager_t em = {
        ...
        .entity_record = dats_dynamic_array_new(4, sizeof(ents_record_t)),
    };
...
ents_entity_t ents_entity_manager_entity_create(ents_entity_manager_t *self)
{
    ...
    else
    {
        ...
        ents_record_t record = {
            .archetype = NULL,
            .row = 0,
        };
        dats_dynamic_array_add(&self->entity_record, &record);
...
void ents_entity_manager_free(ents_entity_manager_t *self)
{
    ...
    //     ents_type_free(type);
    // }
    dats_dynamic_array_free(&self->entity_record);
